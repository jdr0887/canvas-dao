...
@Entity
@Table(schema = "clinbin", name = "incidental_bin_gene", indexes = {
        @Index(name = "incidental_bin_gene_gene_id_idx", columnList = "gene_id"),
        @Index(name = "incidental_bin_gene_incidental_bin_id_idx", columnList = "incidental_bin_id") })
