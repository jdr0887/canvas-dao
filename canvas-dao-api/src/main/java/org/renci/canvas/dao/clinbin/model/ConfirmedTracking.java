...
@Entity
@Table(schema = "clinbin", name = "confirmed_tracking", indexes = {
        @Index(name = "confirmed_tracking_loc_var_id_idx", columnList = "loc_var_id"),
        @Index(name = "confirmed_tracking_phenotype_id_idx", columnList = "phenotype_id") })
