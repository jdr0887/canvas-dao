...
@Entity
@Table(schema = "clinbin", name = "analysis_note", indexes = { @Index(name = "analysis_note_loc_var_id_idx", columnList = "loc_var_id"),
        @Index(name = "analysis_note_phenotype_id_idx", columnList = "phenotype_id") })
