...
public class OneKGenomesSNPFrequencyPopulation implements Persistable<OneKGenomesSNPFrequencyPopulationPK> {
    ...
    @EmbeddedId
    private OneKGenomesSNPFrequencyPopulationPK id;
    ...
    public OneKGenomesSNPFrequencyPopulation() {
        super();
    }

    public OneKGenomesSNPFrequencyPopulationPK getId() {
        return id;
    }

    public void setId(OneKGenomesSNPFrequencyPopulationPK id) {
        this.id = id;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OneKGenomesSNPFrequencyPopulation other = (OneKGenomesSNPFrequencyPopulation) obj;
