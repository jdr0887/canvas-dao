...
@Embeddable
public class GnomADVariantFrequencyPK implements Serializable {
    ...
    public GnomADVariantFrequencyPK() {
        super();
    }

    public GnomADVariantFrequencyPK(Long locatedVariant, String version, String population) {
        super();
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        GnomADVariantFrequencyPK other = (GnomADVariantFrequencyPK) obj;
