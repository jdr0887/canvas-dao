...
@Embeddable
public class OneKGenomesSNPFrequencySubpopulationPK implements Serializable {
    ...
    public OneKGenomesSNPFrequencySubpopulationPK() {
        super();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OneKGenomesSNPFrequencySubpopulationPK other = (OneKGenomesSNPFrequencySubpopulationPK) obj;
        if (version == null) {
