...
@Embeddable
public class OneKGenomesSNPFrequencyPopulationPK implements Serializable {
    ...
    public OneKGenomesSNPFrequencyPopulationPK() {
        super();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OneKGenomesSNPFrequencyPopulationPK other = (OneKGenomesSNPFrequencyPopulationPK) obj;
        if (version == null) {
