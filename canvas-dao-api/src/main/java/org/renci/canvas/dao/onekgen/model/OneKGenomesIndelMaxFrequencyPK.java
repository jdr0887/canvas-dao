...
@Embeddable
public class OneKGenomesIndelMaxFrequencyPK implements Serializable {
    ...
    public OneKGenomesIndelMaxFrequencyPK() {
        super();
    }

    public OneKGenomesIndelMaxFrequencyPK(Long locatedVariant, Integer version) {
        super();
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OneKGenomesIndelMaxFrequencyPK other = (OneKGenomesIndelMaxFrequencyPK) obj;
        if (version == null) {
